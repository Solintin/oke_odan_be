...
export interface IHouseAgent extends IUser {
  agentType: AgentType;
...
export interface IHouseAgentDocument extends IHouseAgent, Document {}
...
const AgentSchema = new Schema<IHouseAgent>(
  {
    agentType: { type: String, enum: Object.values(AgentType), required: true },
...
const HouseAgentModel: Model<IHouseAgentDocument> =
  UserModel.discriminator<IHouseAgentDocument>(
    UserType.HOUSE_AGENT,
    AgentSchema
  );

export default HouseAgentModel;
